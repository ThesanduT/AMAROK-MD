...
const parsejid = (id, seperator = " ") => {
  return id.split(seperator)  
}
...
var matchedquery = query.match(httpRegexG)
  return matchedquery 
}
...
module.exports = { parsejid, runtime, checkWAVersion, getRandom, getBuffer, fetchJson, fetchText, mUrl, mYtId, getRandom, webp2mp4File, tint, listall, manga, analucia, ladybug,  strikeThrough, wingdings, vaporwave, typewriter, runes, serif_B, serif_BI, tildeStrikeThrough  }
